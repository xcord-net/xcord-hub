        ...
        string adminPasswordHash = "")
    {
        ...
        var config = new
        {
            ...
            tier = new
            {
                ...
                maxConcurrentBroadcasts = resourceLimits?.MaxConcurrentBroadcasts ?? 0,
                maxStageSize = resourceLimits?.MaxStageSize ?? 0,
                maxStreambotsPerChannel = resourceLimits?.MaxStreambotsPerChannel ?? 0,
