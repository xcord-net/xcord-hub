...
export default function Account() {
  ...
  return (
    <>
      ...
      <h1 data-testid="account-heading" class="font-display text-2xl font-bold tracking-[-0.01em] text-xcord-text-primary mb-8">Account</h1>
      ...
      <div class="bg-xcord-bg-secondary rounded-lg p-6 mb-6">
        ...
        <form onSubmit={handleSaveProfile} class="space-y-4">
          ...
          <button
            ...
            class="px-4 py-2 bg-xcord-brand hover:bg-xcord-brand-hover disabled:opacity-50 text-xcord-landing-bg rounded text-sm font-medium transition"
          >
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-3">
              <button
                ...
                class="px-4 py-2 bg-xcord-red text-xcord-text-primary hover:opacity-80 disabled:opacity-50 rounded text-sm font-medium transition"
              >
