...
export default function SelfHosting() {
  ...
  return (
    <article class="max-w-3xl mx-auto px-6 py-20 text-xcord-landing-text">
      ...
      />
      <h1 class="font-display text-4xl sm:text-5xl font-extrabold tracking-[-0.02em] text-xcord-landing-text mb-2">Self-Hosting Guide</h1>
      ...
      {/* Prerequisites */}
      <section class="mb-12">
        <h2 class="font-display text-2xl font-bold tracking-[-0.01em] text-xcord-landing-text mb-4">Prerequisites</h2>
        ...
        <div class="mt-4 rounded-lg bg-xcord-landing-surface border border-xcord-landing-border p-4">
          <h3 class="text-sm font-semibold text-xcord-landing-text mb-2">Minimum Server Requirements</h3>
      ...
      {/* Step 1 */}
      <section class="mb-12">
        <h2 class="font-display text-2xl font-bold tracking-[-0.01em] text-xcord-landing-text mb-4">1. Clone the Repositories</h2>
...
git clone https://github.com/xcord-net/xcord-topo.git`}</code>
        ...
        <p class="mt-3 text-sm text-xcord-landing-text-muted">
          <strong class="text-xcord-landing-text">xcord-fed</strong> is your chat server.{' '}
          <strong class="text-xcord-landing-text">xcord-topo</strong> is the topology designer you'll use to design and deploy your infrastructure.
        </p>
      </section>

      {/* Step 2 */}
      <section class="mb-12">
        <h2 class="font-display text-2xl font-bold tracking-[-0.01em] text-xcord-landing-text mb-4">2. Start the Topology Designer</h2>
        <pre class="rounded-lg bg-xcord-landing-surface border border-xcord-landing-border p-4 text-sm overflow-x-auto">
          <code>{`cd xcord-topo
./run.sh`}</code>
        </pre>
      ...
      {/* Step 3 */}
      <section class="mb-12">
        <h2 class="font-display text-2xl font-bold tracking-[-0.01em] text-xcord-landing-text mb-4">3. Design Your Infrastructure</h2>
        <ol class="space-y-3 text-sm list-decimal list-inside">
          <li>Open <code class="text-xcord-brand">http://localhost:8090</code> and click <strong class="text-xcord-landing-text">New Topology</strong></li>
          <li>Drag a <strong class="text-xcord-landing-text">Host</strong> container from the catalog onto the canvas - this represents your server</li>
          <li>
            ...
            <ul class="mt-2 ml-5 space-y-1 list-disc text-xcord-landing-text-muted">
              <li><strong class="text-xcord-landing-text">FederationServer</strong> - the xcord instance</li>
              <li><strong class="text-xcord-landing-text">PostgreSQL</strong> - database</li>
              <li><strong class="text-xcord-landing-text">Redis</strong> - cache and message broker</li>
              <li><strong class="text-xcord-landing-text">MinIO</strong> - file storage</li>
              <li><strong class="text-xcord-landing-text">LiveKit</strong> - voice/video server</li>
              <li><strong class="text-xcord-landing-text">Caddy</strong> - reverse proxy with automatic TLS</li>
            </ul>
          </li>
          <li>Draw <strong class="text-xcord-landing-text">wires</strong> between services to establish connections (e.g., FederationServer → PostgreSQL)</li>
        </ol>
      </section>

      {/* Step 4 */}
      <section class="mb-12">
        <h2 class="font-display text-2xl font-bold tracking-[-0.01em] text-xcord-landing-text mb-4">4. Deploy with the Wizard</h2>
        <p class="text-sm mb-4">
          Click <strong class="text-xcord-landing-text">Deploy</strong> in the toolbar to open the deploy wizard. It walks you through:
        </p>
        <div class="space-y-3">
          {[
      ...
      {/* Step 5 */}
      <section class="mb-12">
        <h2 class="font-display text-2xl font-bold tracking-[-0.01em] text-xcord-landing-text mb-4">5. Verify Your Deployment</h2>
        <pre class="rounded-lg bg-xcord-landing-surface border border-xcord-landing-border p-4 text-sm overflow-x-auto">
...
# Should return 200 OK`}</code>
      ...
      {/* Troubleshooting */}
      <section class="mb-12">
        <h2 class="font-display text-2xl font-bold tracking-[-0.01em] text-xcord-landing-text mb-4">Troubleshooting</h2>
        <div class="rounded-lg bg-xcord-landing-surface border border-xcord-landing-border overflow-hidden text-sm">
          {[
            ...
            <div class={`flex gap-4 px-4 py-3 ${i > 0 ? 'border-t border-xcord-landing-border' : ''}`}>
              <span class="shrink-0 w-40 font-medium text-xcord-landing-text">{row.problem}</span>
